...
GLfloat color[8][3] = 
{
    {0.1, 0.5, 0.2},       //vertice A
    {0.1, 0.5, 0.2},       //vertice B 
    {0.1, 0.5, 0.2},       //vertice C
    {0.1, 0.5, 0.2},       //vertice D
    {0.1, 0.5, 0.2},       //vertice E
    {0.1, 0.5, 0.2},       //vertice F
    {0.1, 0.5, 0.2},       //vertice G
    {0.1, 0.5, 0.2},       //vertice H
};
...
{
    {0.6, 0.2, 0.0},       //vertice A
    {0.6, 0.2, 0.0},       //vertice B 
    {0.6, 0.2, 0.0},       //vertice C
    {0.6, 0.2, 0.0},       //vertice D
    {0.6, 0.2, 0.0},       //vertice E
    {0.6, 0.2, 0.0},       //vertice F
    {0.6, 0.2, 0.0},       //vertice G
    {0.6, 0.2, 0.0},       //vertice H
};

// Rede
float vertex_rede[8][3] = 
{
    {-0.05, 0.2, 1.5},        //vertice A 
    {-0.05, 0.7, 1.5},        //vertice B 
    {0.05, 0.7, 1.5},         //vertice C
    {0.05, 0.2, 1.5},         //vertice D
    {-0.05, 0.2, -1.5},       //vertice E 
    {-0.05, 0.7, -1.5},       //vertice F 
    {0.05, 0.7, -1.5},        //vertice G
    {0.05, 0.2, -1.5},        //vertice H
};
...
void desenha()
{
    ...
    bresenham(2.3, 0.23, -2.3, 0.23, 1.2);
    bresenham(2.3, 0.23, -2.3, 0.23, -1.2);

    bresenham(1.2, 0.23, -1.2, 0.23, 0);

    bresenham(2.3, 0.23, 2.2, 0.23, 0);
    bresenham(-2.3, 0.23, -2.2, 0.23, 0);
    ...
    bresenham(1.2, 0.23, -1.2, 0.23, -1.2);
    bresenham(1.2, 0.23, -1.2, 0.23, 1.2);
